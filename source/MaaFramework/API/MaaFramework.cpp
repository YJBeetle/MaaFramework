...
MaaController* MaaGamepadControllerCreate(void* hWnd, MaaGamepadType gamepad_type, MaaWin32ScreencapMethod screencap_method)
{
    ...
    auto control_unit = MAA_NS::GamepadControlUnitLibraryHolder::create_control_unit(hWnd, gamepad_type, screencap_method);
